<template>
  <view class="mine-page">
    ...
    <view class="service-list">
      <view 
        class="service-item" 
        v-for="(item, index) in systemServices" 
        :key="index"
        @click="navigateTo(item.path)">
        <view class="left">
...
export default {
  ...
  data() {
    return {
	  ...
	  quickServices:[
        { name: '门店管理', icon: 'shop', path: '/pages/profile/store', class: 'bg-red' },
        { name: '配送管理', icon: 'staff', path: '/pages/profile/courier', class: 'bg-blue' }
      ],
      systemServices: [
        { name: '客服中心', icon: 'headphones', path: '/pages/profile/service', class: 'bg-orange', desc: '在线客服' },
        { name: '帮助中心', icon: 'help', path: '/pages/profile/help', class: 'bg-cyan' },
        { name: '意见反馈', icon: 'chat', path: '/pages/profile/feedback', class: 'bg-pink' },
        { name: '设置', icon: 'gear', path: '/pages/profile/settings', class: 'bg-gray' }
      ]
    }
  },
  methods: {
